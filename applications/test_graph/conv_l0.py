...
class GINConv(MessagePassing):
    def __init__(self, emb_dim, droprate_init, temperature, budget, weight_decay, 
        ...
        self.edge_encoder = Linear(7, emb_dim, droprate_init=droprate_init, temperature=temperature, 
                                    budget=budget, weight_decay=weight_decay, lamba=lamba, local_rep=local_rep, 
                                    device=device, use_reg=use_reg)
    ...
    def prune(self, in_mask, out_mask):
        ...
        if in_mask:
            ...
            tp.prune_linear_out_channels(self.edge_encoder, idxs=in_mask)
...
class GCNConv(MessagePassing):
    def __init__(self, emb_dim, droprate_init, temperature, budget, weight_decay, 
        ...
        # self.edge_encoder = Linear(7, emb_dim, droprate_init=droprate_init, temperature=temperature, budget=budget, weight_decay=weight_decay, 
        #                            lamba=lamba, local_rep=local_rep, device=device, use_reg=use_reg)
