...
class GNN(torch.nn.Module):
    def __init__(self, num_class = 2, num_layer = 5, emb_dim = 300, 
...
def gnn_model(num_classes=2, **kwargs):
    valid_args = ['num_layer', 'emb_dim', 'gnn_type', 'virtual_node', 'residual', 'drop_ratio', 'JK', 'graph_pooling']
    gnn_kwargs = {k: v for k, v in kwargs.items() if k in valid_args}
    return GNN(num_class=num_classes, **gnn_kwargs)
